...
INTENT_KEYWORDS: dict[str, list[str]] = {
    ...
    "supply_contract": [
        ...
        "тұрмыстық шарт", "электрмен жабдықтау шарты", "шарт жасасу",
    ],
    "load_calculation": [
        "расчет нагрузки", "расчёт нагрузки", "расчет электрической",
        "электрическая нагрузка", "жүктеме есебі", "жүктемені есептеу",
    ],
    "draft_design": [
    ...
    "construction_works": [
        ...
        "құрылыс-монтаж", "құрылыс монтаждау",
    ],
    "meter_sealing": [
    ...
    "primary_connection": [
        "первичное подключение", "первичного подключения", "первичное тех", "первичка",
        "подключение к сетям", "бастапқы қосылу", "алғашқы қосылу",
    ],
}
